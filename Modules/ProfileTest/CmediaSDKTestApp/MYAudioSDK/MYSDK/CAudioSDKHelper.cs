...
namespace MYAudioSDK.MYSDK
{
    ...
    /// </summary>
    class CAudioSDKHelper
    {
        private static CAudioSDKHelper _instance;
        /// <summary>
        /// Gets the instance.
        /// </summary>
        public static CAudioSDKHelper Instance
        {
            get
            {
                return _instance ?? (_instance = new CAudioSDKHelper());
            }
        }
