...
namespace PCVolumeControl
{
    public class VolumeControl
    {
        ...
        /// <returns></returns>
        protected static bool GetMixer(int i, int type, int ctrlType, out VolumeStructs.Mixer mixerControl, out int currVolume)
        {
            ...
            line.dwComponentType = (uint)type;
        ...
        protected static bool SetMixer(int i, VolumeStructs.Mixer mixerControl, int volumeLevel)
        {
