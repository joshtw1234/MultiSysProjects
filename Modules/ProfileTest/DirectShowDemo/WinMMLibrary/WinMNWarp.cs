...
namespace WinMMLibrary
{
    internal class WinMNWarpConstants
    {
        internal const int MAXPNAMELEN = 32;
        internal const int MIXER_SHORT_NAME_CHARS = 16;
        internal const int MIXER_LONG_NAME_CHARS = 64;

        [DllImport("WinMM.dll", CharSet = CharSet.Auto)]
        internal static extern uint mixerGetLineInfo(IntPtr hmxobj, ref MIXERLINE pmxl, MIXER flags);

        [DllImport("WinMM.dll", CharSet = CharSet.Auto)]
        internal static extern uint mixerGetLineControls(IntPtr hmxobj, ref MIXERLINECONTROLS pmxlc, MIXER flags);

        [DllImport("WinMM.dll", CharSet = CharSet.Auto)]
        internal static extern uint mixerGetControlDetails(IntPtr hmxobj, ref MIXERCONTROLDETAILS pmxcd, MIXER flags);
    ...
    internal struct TargetInfo
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = WinMNWarpConstants.MAXPNAMELEN)]
    ...
    internal struct MIXERLINE
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = WinMNWarpConstants.MIXER_SHORT_NAME_CHARS)]
        public string szShortName;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = WinMNWarpConstants.MIXER_LONG_NAME_CHARS)]
    ...
    public class WinMMWarpItem
    {
        private static WinMMWarpItem _instance;
        /// <summary>
        /// Gets the instance.
        /// </summary>
        public static WinMMWarpItem Instance
        {
            get
            {
                return _instance ?? (_instance = new WinMMWarpItem());
            }
        }
        public bool GetMixerControls(out MixerInfo data)
        {
            ...
            var errCode = WinMNWarpConstants.mixerGetLineInfo(IntPtr.Zero, ref mxl, MIXER.OBJECTF_MIXER | MIXER.GETLINEINFOF_DESTINATION);
            ...
            //MyMixerInfo rtn = new MyMixerInfo();
            data = new MixerInfo();
            ...
            //            data.volumeCtl = mxc.dwControlID;
            //            data.minVolume = mxc.Bounds.lMinimum;
            //            data.maxVolume = mxc.Bounds.lMaximum;
            //            break;
            //        case MIXERCONTROL_CONTROLTYPE.MUTE:
            //            data.muteCtl = mxc.dwControlID;
            //            break;
            //    }
            //}
